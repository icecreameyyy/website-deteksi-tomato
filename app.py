...
CLASS_DESCRIPTIONS = {
    "Antranoksa": "Antraknosa adalah penyakit yang disebabkan oleh jamur dari genus Colletotrichum. Gejalanya berupa bercak cekung berwarna cokelat kehitaman pada buah. Pada tahap lanjut,bercak dapat membesar dan menyebabkan jaringan tanaman mati.",
